...
namespace AMMS.Infrastructure.Interfaces
{
    public interface ITaskRepository
    {
        ...
        Task<task?> GetByIdWithProcessAsync(int taskId, CancellationToken ct = default);
        ...
        Task<List<task>> GetTasksByProductionWithProcessAsync(int prodId, CancellationToken ct = default);
        ...
        Task MarkTaskReadyAsync(int taskId, DateTime now, CancellationToken ct = default);
